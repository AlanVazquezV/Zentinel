<template>
    <div :class="containerClass" @click="onWrapperClick">
        <template v-if="auth.isLoggedIn">
            <div class="layout-topbar surface-200 shadow-7">
                ...
                <div class="layout-topbar-menu flex-grow-1 justify-content-between">
                    ...
                    <SplitButton class="layout-menu-user-button"  icon="pi pi-user" :model="appBarActionMenu">
                        <router-link to="/account">
                            <Avatar shape="circle" class="surface-200 text-white" size="large" icon="pi pi-user" />
                            </router-link>
                        </SplitButton>
                    </div>
                </div>
                <div class="layout-sidebar   shadow-7" @click="onSidebarClick">
                    <div class="text-center pt-2 surface-100 mb-1">
                        <router-link to="/account">
                    ...
                    <template v-else>
                        <div class="layout-topbar surface-200 text-white shadow-7">
