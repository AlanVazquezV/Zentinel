...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'schedulesstatusview',
		},
		apiPath: {
			type: String,
			default: 'schedulesstatus/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'schedulesstatus/edit', url: `/schedulesstatus/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
