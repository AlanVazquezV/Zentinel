                            ...
                            <div >
                                <div class="mb-3 grid justify-content-start">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Description</div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Create At</div>
                                                <div class="font-bold">{{ item.create_at }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
...
<script setup>
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'role/edit', url: `/role/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
