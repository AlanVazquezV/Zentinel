        ...
        <TabView v-model:activeIndex="activeTab">
            <template v-if="auth.canView('permissions/list')">
                <TabPanel>
                    ...
                    <div class="">
                        <PermissionsListPage ref="permissionsListPage"  field-name="permissions.id" :field-value="masterRecord.id" :show-header="false" :show-breadcrumbs="false" isSubPage>
                        </PermissionsListPage>
                    </div>
                </TabPanel>
            </template>
