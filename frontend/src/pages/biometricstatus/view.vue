...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'biometricstatusview',
		},
		apiPath: {
			type: String,
			default: 'biometricstatus/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'biometricstatus/edit', url: `/biometricstatus/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
