...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'employeestatusview',
		},
		apiPath: {
			type: String,
			default: 'employeestatus/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'employeestatus/edit', url: `/employeestatus/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
