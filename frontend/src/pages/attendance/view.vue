                                ...
                                <div class="mb-3 grid justify-content-start">
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Fecha</div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Check Type</div>
                                                <div class="font-bold">{{ item.check_type }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">{{ item.employees_employee_number }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">{{ item.attendancestatus_label }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script setup>
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'attendance/edit', url: `/attendance/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
