...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'positionsstatusview',
		},
		apiPath: {
			type: String,
			default: 'positionsstatus/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'positionsstatus/edit', url: `/positionsstatus/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
