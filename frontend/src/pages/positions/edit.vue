                                    ...
                                    <div class="grid">
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrltitle" v-model.trim="formData.title"  label="Posicion" type="text" placeholder="Escribir Posicion"      
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrlparent" v-model.trim="formData.parent"  label="Parent" type="number" placeholder="Escribir Parent"   step="any"    
                                                    class=" w-full" :class="getErrorClass('parent')">
                                                    </InputText>
                                                    <small v-if="isFieldValid('parent')" class="p-error">{{ getFieldError('parent') }}</small> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <api-data-source   api-path="components_data/status_option_list_5" >
                                                        <template v-slot="req">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'positionsedit',
		},
		pagePath: {
			type : String,
			default : 'positions/edit',
		},
		apiPath: {
			type: String,
			default: 'positions/edit',
