                                ...
                                <div class="mb-3 grid justify-content-start">
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Title</div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Parent</div>
                                                <div class="font-bold">{{ item.parent }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Positionsstatus Label</div>
                                                <div class="font-bold">{{ item.positionsstatus_label }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script setup>
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'positions/edit', url: `/positions/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
