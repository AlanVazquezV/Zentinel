                        ...
                        <div >
                            ...
                            <div class="page-records"  >
                                <DataTable :lazy="true"   :loading="loading"    v-model:selection="selectedItems"
                                     :value="records" dataKey="permission_id" @sort="onSort($event)" class=" table-hover table-striped" :showGridlines="false" :rowHover="true" responsiveLayout="stack">
                                    <Column selectionMode="multiple" headerStyle="width: 2rem" />
                                        <Column  field="permission_id" header="Permission Id" >
                                            <template #body="{data}">
                                        ...
                                        <Column  field="id" header="Id" >
                                            <template #body="{data}">
                                                <Button class="p-button-text" icon="pi pi-eye" label="Role" v-if="data.id" @click="app.openPageDialog({ page: 'role/view', url: `/role/view/${data.id}` , closeBtn: true })" />
                                            </template>
                                        </Column>
