                                ...
                                <div class="mb-3 grid justify-content-start">
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Permission Id</div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Permission</div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">
                                                    <Button class="p-button-text" icon="pi pi-eye" label="Role Detail" v-if="item.id" @click="app.openPageDialog({ page: 'role/view', url: `/role/view/${item.id}` , closeBtn: true })" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
