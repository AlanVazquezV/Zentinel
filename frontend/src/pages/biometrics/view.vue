                                ...
                                <div class="mb-3 grid justify-content-start">
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Value</div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">{{ item.biometricstatus_label }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">{{ item.biometrictypes_label }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'biometricsview',
		},
		apiPath: {
			type: String,
			default: 'biometrics/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'biometrics/edit', url: `/biometrics/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
