                                ...
                                <div >
                                    <form ref="observer"  tag="form" @submit.prevent="startLogin()">
                                        <div class="mb-2 p-input-icon-right w-full">
                                            ...
                                            <InputText label="Nombre de usuario" placeholder="Nombre de usuario" class="w-full" v-model.trim="formData.username"  required="required" type="text" />
                                        </div>
                                        <div class="mb-2 p-input-icon-left w-full">
                                            <i class="pi pi-lock"></i>
                                            <Password label="Contraseña" inputClass="w-full" :feedback="false" toggleMask class="w-full" placeholder="Contraseña" required="required" v-model="formData.password" />
                                        </div>
                                        <div class="flex justify-content-between align-items-center my-2">
                                            <div class="flex align-items-center">
                                                ...
                                                <label class="text-sm text-500" for="rememberme">Recuérdame</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <Button label="Iniciar sesión"  :loading="loading" icon="pi pi-lock-open" class="p-button-lg p-button-raised w-full" type="submit"> 
                                            </Button>
                                        </div>
                                    </form>
                                </div>
