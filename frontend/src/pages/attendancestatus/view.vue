...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'attendancestatusview',
		},
		apiPath: {
			type: String,
			default: 'attendancestatus/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'attendancestatus/edit', url: `/attendancestatus/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
