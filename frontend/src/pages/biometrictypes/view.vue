...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'biometrictypesview',
		},
		apiPath: {
			type: String,
			default: 'biometrictypes/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'biometrictypes/edit', url: `/biometrictypes/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
